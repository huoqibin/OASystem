...
<ul class="nav nav-tabs nav-justified">
    <li class="nav-item">
        <a class="nav-link btn-outline-secondary" href="${ctx}/getcompanyallfile/1?group=${sessionScope.userVO.groupId}">公司文件</a>
    </li>
    <li class="nav-item">
        <a class="nav-link btn-outline-secondary" href="${ctx}/getgroupallfile/1?group=${sessionScope.userVO.groupId}">小组文件</a>
    </li>
</ul>
<br/>
<div class="container">
    <div class="mx-auto" style="width: 60%">
        <form class="form-inline" method="post" action="${ctx}/selectallfile">
            <input type="hidden" name="currentType" value="${currentTpye}"/>
            <label for="fileClass">分类:</label>
            <input type="text" class="form-control" id="fileClass" name="fileClass" placeholder="如：产线数据">
            &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table class="table table-hover">
        ...
        <c:forEach var="file" items="${fileList}">
            <tr>
                ...
                <td>
                    <a class="btn btn-outline-success" href="${ctx}/downloadfile/${file.fileRealName}">下载</a>
                    <a class="btn btn-outline-danger" href="${ctx}/deletefile/${file.fileRealName}">删除</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="mx-auto" style="width: 40%">
        <ul class="pagination ">
            ...
            <c:if test="${currentTpye == 1}">
                <c:if test="${page.startPage>=1}">
                    <li class="page-item"><a class="page-link" href="${ctx}/getgroupallfile/${page.startPage-1}">上一页</a></li>
                    <li class="page-item"><a class="page-link" href="${ctx}/getgroupallfile/${page.startPage-1}">${page.startPage-1}</a></li>
                </c:if>
                <li class="page-item"><a class="page-link" href="#" data-toggle="tooltip" title="当前为第${page.startPage}页,总${page.fullPage}页!">${page.startPage}</a></li>
                <c:if test="${page.startPage <= page.fullPage}">
                    <li class="page-item"><a class="page-link" href="${ctx}/getgroupallfile/${page.startPage+1}">${page.startPage+1}</a></li>
                    <li class="page-item"><a class="page-link" href="${ctx}/getgroupallfile/${page.startPage+1}">下一页</a></li>
                </c:if>
            </c:if>
        </ul>
    </div>
